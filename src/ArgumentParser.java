...
public class ArgumentParser {
	...
	public boolean isFlag(String arg) {
		return (arg != null && arg.startsWith("-") && arg.length() > 1 && !Character.isDigit(arg.charAt(1)));
	...
	/**
	 * method used to provide a default value for the number of threads to use if an
	 * invalid value has been provided with a thread flag
	 * 
	 * @param arg to use
	 * @return the number of threads to use
	 */
	public int threadArgs(String arg) {
		try {
			if (arg.startsWith("-") || arg.contains(".") || arg.isBlank() || arg.isEmpty()
					|| Character.isLetter(arg.charAt(0))) {
				return 5;
			}
